...
import { Slide } from "react-slide"; // Correctly importing from react-slide
// import "react-slide/lib/slidedown.css"; // Keep the CSS import for react-slide
...
const FaqItem = ({ item, index }) => {
  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      <Slide in={activeId === item.id}> {/* Correct usage of Slide */}
        <div className="body-3 px-7 py-3.5">{item.answer}</div>
      </Slide>

      <div
        className={clsx(
          "g5 -bottom-7 -top-7 left-0 right-0 -z-1 rounded-3xl opacity-0 transition-opacity duration-500",
          active && "opacity-100"
        )}
      >
